"""
Test suite for {{ cookiecutter.repo_name }}.google_subpkg subpackage
"""

__author__ = 'mdelpozobanos'

import pytest
from {{ cookiecutter.repo_name }} import google_subpkg
...
class TestGClass():
    """Class to test the {{ cookiecutter.repo_name }}.google_subpkg.GClass class"""
...
# Test the main file
from {{ cookiecutter.repo_name }}.google_subpkg import main
